...
<html lang="pt-br">
    ...
    <body>
      ...
      <svg onclick="scrollToTop()" id="btn-top" width="90" height="90" viewBox="0 0 90 90" fill="none"
        ...
        <div id="main-popup" class="background-popup"> 

        <div class="popup">
      
        <div class="logo-content">
            <i id="btn-fechar" class="fa-regular fa-circle-xmark fa-2x"></i>
            <img src="../img/beeongs/sub logo.svg" alt="" class="img-logo" >
            <h1 class="title-login">BEM-VINDO DE VOLTA!</h1>
        </div>

        <div class="login-popup-content">
        <h1 class="title-login">FAÇA O LOGIN</h1>
        ...
        <form action="../controllers/login.php" method="post">
            ...
            <button id="btn-click" class="btn-login-popup">Entrar</button>
            <p class="register-text">Ainda não registrou uma conta? 
            <a class="" href="register-page.php">Registre-se.</a>
            </p>
