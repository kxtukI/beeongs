...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="#">Something else here</a>
      ...
      <!-- <a href="login-page.php" class="btn-login border-animation" href="login-page.php">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 20 20" fill="none" stroke="#E9D758" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <section class="main-section container">
      <div class="main-section-content container">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
          ...
          pellentesque pretium et pretium etiam enim. 
          Amet, at sit ut imperdiet orci. Curabitur diam
           arcu nam gravida senectus scelerisque sodales. 
          Pellentesque ullamcorper arcu egestas scelerisque libero quis tincidunt. 
          Morbi nibh faucibus enim phasellus viverra a. 
          Eros nullam eget ultrices vitae tristique cum tellus. 
          Mi quis sapien mattis turpis pellentesque ultrices turpis dolor. 
          Egestas tincidunt venenatis tellus felis. </p>
      </div>
      <img src="../img/foto-main-section.jpg" alt="">
    </section>
    <svg class="background-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#e9d758" fill-opacity="1" d="M0,224L48,234.7C96,245,192,267,288,250.7C384,235,480,181,576,160C672,139,768,149,864,160C960,171,1056,181,1152,160C1248,139,1344,85,1392,58.7L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
      <svg class="background-wave-second" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#1F1300" fill-opacity="1" d="M0,288L48,250.7C96,213,192,139,288,138.7C384,139,480,213,576,218.7C672,224,768,160,864,138.7C960,117,1056,139,1152,170.7C1248,203,1344,245,1392,266.7L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
